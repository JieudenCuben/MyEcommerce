...
public class UpdateProductInfoActivity extends AppCompatActivity {
    ...
    String name,description,pushId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edDesc=findViewById(R.id.ed_product_desc_update);
        edName=findViewById(R.id.ed_product_name_update);
        imgProduct=findViewById(R.id.image_product_update);
        ...
        edDesc.setText(intent.getStringExtra("desc"));
        ...
        Glide.with(this).load(url).apply(options).into(imgProduct);
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            storageReference2nd.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    mDatabaseRef=mDatabaseRef.child("AllProducts").child(pushId);
...
//
                                    ...
                                    Intent intent = new Intent(UpdateProductInfoActivity.this, BusinessDashboard.class);
...
//                            databaseReference.child(ImageUploadId).setValue(imageUploadInfo);
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception exception) {
                            ...
                            Toast.makeText(UpdateProductInfoActivity.this, exception.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    })
            ...
            Toast.makeText(UpdateProductInfoActivity.this, "Please Select Image or Add Image Name", Toast.LENGTH_LONG).show();
