...
import com.example.myecommercesystem.fragments.BusinessHomeFragment;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.add_product:
                        Intent intent = new Intent(BusinessDashboard.this, AddProductActivity.class);
                        startActivity(intent);
                        drawer.closeDrawer(GravityCompat.START);
                        return true;

                    case R.id.accept_appointment:
                        Intent intent3 = new Intent(BusinessDashboard.this, ShowAppointmentsActivity.class);
                        startActivity(intent3);
                        drawer.closeDrawer(GravityCompat.START);
//
                        return true;
                    case R.id.update_info:
                        Intent intent2 = new Intent(BusinessDashboard.this, UpdateUserInfoActivity.class);
                        intent2.putExtra("activity","business");
                        startActivity(intent2);
                        drawer.closeDrawer(GravityCompat.START);
                        return true;
                    case R.id.logout:
                        AlertDialog alertDialog = new AlertDialog.Builder(BusinessDashboard.this)
//set icon
...
//set title
                                ...
                                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        ...
                                        Intent intent = new Intent(BusinessDashboard.this, MainActivity.class);
